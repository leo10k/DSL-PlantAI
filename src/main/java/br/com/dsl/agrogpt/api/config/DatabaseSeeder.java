...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        clienteRepository.saveAll(List.of(
            Cliente.builder().name("Claudio").genero("Masculino").email("claudio@gmail.com").cpf(11111111111L).cnpj(null).dataNascimento(LocalDate.of(1978, 4, 20)).dataCadastro(LocalDate.of(2020, 7, 13)).status('A').problema(Collections.singletonList(prob1)).telefone(tel1).build(),
            Cliente.builder().name("Joao").genero("Masculino").email("joao@gmail.com").cpf(null).cnpj(22222222222222L).dataNascimento(LocalDate.of(1965, 2, 14)).dataCadastro(LocalDate.of(2021, 2, 24)).status('F').problema(Collections.singletonList(prob2)).telefone(tel2).build()
